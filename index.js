...
const config = {
    A187: '👾Alpin👾', // TOBAT SU ASU
    instagram: 'https://instagram.com/alpin', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6289690719275', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtu.be/x5kZpxEQmlo', // KINTIL
    whatsapp: 'kosongs', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6289690719275@s.whatsapp.net"] // ganti nomer lu
           ...
           case 'demote':
              ...
              case 'abgjago':
				...
				case 'url2img': 
					...
					if (!tipelist.includes(args[0])) return reply('𝐓𝐢𝐩𝐞 𝐚𝐩𝐚 𝐝𝐞𝐤??𝐭𝐨𝐩|𝐭𝐚𝐛𝐥𝐞𝐭|𝐦𝐨𝐛𝐢𝐥𝐞')
